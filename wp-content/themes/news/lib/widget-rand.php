...
class posts_widget extends WP_Widget {
	...
	function posts_widget() {
		$widget_ops = array( 'classname' => 'posts_widget', 'description' => 'Display specific category posts in the sidebar' ); // Widget Settings
		$control_ops = array( 'id_base' => 'posts_widget' ); // Widget Control Settings
		$this->WP_Widget( 'posts_widget', 'Footer News Posts Widget HK', $widget_ops, $control_ops ); // Create the widget
	}
...
<ul class="postfeatured">
		<?php $postquery = new WP_Query(array('posts_per_page' => $postsnumber));
